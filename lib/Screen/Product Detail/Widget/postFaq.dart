  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Column(
        ...
        children: <Widget>[
          Text(
            getTranslated(context, 'Have any comments regarding this product'),
            style: TextStyle(
          ...
          Padding(
            ...
            child: CupertinoButton(
              ...
              child: Container(
                ...
                child: Text(
                  getTranslated(context, 'POST YOUR COMMENTS'),
                  ...
                  child: Column(
                    ...
                    children: [
                      Padding(
                        ...
                        child: Text(
                          getTranslated(context, 'Write a Comments'),
                                    ...
                                    validator: (val) {
                                      if (val!.isEmpty) {
                                        return getTranslated(context,
                                            'Please provide more details on your comments');
                                      }
                                      return null;
                                    },
                                    decoration: InputDecoration(
                                      hintText: getTranslated(
                                          context, 'Type your comments'),
                                      hintStyle: TextStyle(
                                          color: Theme.of(context)
                                              .colorScheme
                                              .black),
