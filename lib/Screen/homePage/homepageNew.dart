...
import 'package:eshop_multivendor/Helper/routes.dart' as HelperRoutes; // Alias import for Routes
import 'package:eshop_multivendor/Screen/homePage/homepageNew.dart' as HomePageRoutes;
        ...
        child: SafeArea(
          child: isNetworkAvail
            ...
            padding: EdgeInsets.only(
              top: context.watch<HomePageProvider>().getBars ? 0 : 40,
            ),
            child: NestedScrollView(
              // Consider removing the controller to test behavior
              //controller: _scrollBottomBarController,
...
class SearchBarHeaderDelegate extends SliverPersistentHeaderDelegate {
  ...
  Widget build(
    ...
    return Padding(
      ...
      padding:  const EdgeInsets.fromLTRB(0, 0, 0, 0), // Reduced padding horizontally
      child: Align(

        alignment: Alignment.topCenter, // Centered alignment for cleaner layout
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            // border: Border.all(
            //   color: Theme.of(context).colorScheme.fontColor.withOpacity(0),
            // ),
          ),
          padding: const EdgeInsets.symmetric(horizontal: 19.0), // Adjusted inner padding
          child: Row(
            children: [
              Expanded(
                child: InkWell(
              ...
              Padding(
                padding: const EdgeInsets.only(right: 12.0), // Fine-tuned padding
                child: InkWell(
                  onTap: () => Routes.navigateToSearchScreen(context),
                  child: const Icon(Icons.mic, size: 21, color: Colors.black),
                ),
              ),
            ],
          ),
