...
extension colors on ColorScheme {
  ...
  static const Color primary = Color.fromARGB(255, 0, 157, 209);
  static const Color secondary = Color(0xff009dd1);
  static const Color lightBlue = Color(0xFF97E7F5);

  Color get btnColor => brightness == Brightness.dark ? whiteTemp : primary;

  Color get changeablePrimary => brightness == Brightness.dark
      ? const Color(0xff009dd1)
      : const Color(0xff009dd1);
  ...
  static const Color grad1Color = Color(0xff009dd1);
  static const Color grad2Color = Color(0xff009dd1);
